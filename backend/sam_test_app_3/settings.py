"""
Django settings for sam_test_app_3 project.
...
ROOT_URLCONF = 'sam_test_app_3.urls'
...
WSGI_APPLICATION = 'sam_test_app_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sam_test_app_3 API",
    "DESCRIPTION": "API documentation for sam_test_app_3 App",
    "VERSION": "v1",
}
